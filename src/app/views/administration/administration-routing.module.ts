...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'organizations/users/create', data: {breadcrumb: 'Organizations' }, loadChildren: () => import('./../organization/users/create/create-user.module').then(m => m.CreateUserModule)  },
