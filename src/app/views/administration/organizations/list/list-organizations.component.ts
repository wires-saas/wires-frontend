                ...
                items: [
                    {
                        ...
                        command: () => {
                            ...
                            this.router.navigate(['/organization', organization.slug, 'information']);
                        }
                    },
                    {
                        ...
                        command: () => {
                            this.confirmationService.confirm({
                                key: 'confirm-delete',
                                accept: async() => {
                                    await this.organizationService.delete(organization.slug).then(() => {
                                        this.organizations = this.organizations.filter(_ => _.slug !== organization.slug);
