export class CountriesUtils {
    ...
    static countries: Array<{name: string; code: string;}> = [
        {
        ...
        {
            name: $localize `Congo, the Democratic Republic of the`,
            code: "CD"
        },
        {
        ...
        {
            name: $localize `Palestinian Territory, Occupied`,
            code: "PS"
        },
        {
        ...
        {
            name: $localize `Taiwan, Province of China`,
            code: "TW"
        },
        {
        ...
        {
            name: $localize `Venezuela, Bolivarian Republic of`,
            code: "VE"
        },
        {
